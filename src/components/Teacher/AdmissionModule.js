            ...
            <form>
                ...
                <div>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className='col-6'>
                           <label for="degreeGroupChosen"><h6 className='p-2'>Degree Group Chosen</h6></label>
                          <select className="form-select" aria-label="Degree Group Chosen" placeholder="Degree Group Chosen" id="group" onChange={handleChange}>
                               <option value="B.SC(Physics)" selected>B.SC(Physics)</option>
                               <option value="B.SC(Electronics)" selected>B.SC(Electronics)</option>
                               <option value="B.SC(Statistics)" selected>B.SC(Statistics)</option>
