...
const AdmissionModule = () => {
    ...
    const handleChangeCollegePreference = (index, value) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("http://localhost:6767/api/student/studentregistration", { formData })
            if (res.data.message) {
                ...
                <div>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className='col'>
                            ...
                            <select className="form-select" aria-label="Degree Group Chosen Majors" placeholder="Degree Group Chosen Majors" id="degreeGroupChosenMajors" onChange={handleChange}>
                        ...
                        <div className='col'>
                            ...
                            <select className="form-select" aria-label="Degree Group Chosen Minors" placeholder="Degree Group Chosen Minors" id="degreeGroupChosenMinors" onChange={handleChange}>
                                <option value="B.SC(Physics)" >B.SC(Physics)</option>
                    ...
                    <div className='row'>
                        <div className="col form-floating mb-3 ps-2">
                            <input type="text" className="form-control" id="collegePreference" placeholder="1.College Preference" onChange={handleChange} required />
                            <label for="collegePreference">1.College Preference</label>
                        </div>
                        <div className="col form-floating mb-3 ps-2">
                            <input type="text" className="form-control" id="collegePreference" placeholder="2.College Preference" onChange={handleChange} required />
                            <label for="collegePreference">2.College Preference</label>
                        </div>
                        <div className="col form-floating mb-3 ps-2">
                            <input type="text" className="form-control" id="collegePreference" placeholder="3.College Preference" onChange={handleChange} required />
                            <label for="collegePreference">3.College Preference</label>
                        </div>
                        <div className="col form-floating mb-3 ps-2">
                            <input type="text" className="form-control" id="collegePreference" placeholder="4.College Preference" onChange={handleChange} required />
                            <label for="collegePreference">4.College Preference</label>
                        </div>
                        <div className="col form-floating mb-3 ps-2">
                            <input type="text" className="form-control" id="collegePreference" placeholder="5.College Preference" onChange={handleChange} required />
